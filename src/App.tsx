...
const PROJECTS = [
  ...
  {
    title: "Real vs Fake Job Classifier",
    description: "NLP fraud detection trained on 17K+ job listings. TF-IDF + Multinomial Naive Bayes pipeline, Flask REST API, and Chrome Extension for real-time prediction.",
    tech: ["Python", "Flask REST API", "Chrome Extension", "NLP", "TF-IDF"],
    color: "marker-green",
              ...
              <div className="flex items-start justify-between gap-3 mb-3">
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    ...
                    {project.badge && (
                      <span className={`font-sans text-xs font-bold px-2 py-0.5 border-sketch ${project.badge === "Live" ? "bg-primary text-primary-foreground" : "bg-accent text-accent-foreground"}`}>
                        {project.badge}
                      </span>
                    )}
                  </div>
